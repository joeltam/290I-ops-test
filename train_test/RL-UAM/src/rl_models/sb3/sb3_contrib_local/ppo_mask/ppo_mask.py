...
from src.rl_models.sb3.sb3_contrib_local.ppo_mask.policies import GATPolicy
...
class MaskablePPO(OnPolicyAlgorithm):
    ...
    def _setup_model(self) -> None:
        ...
        if not isinstance(self.policy, (MaskableActorCriticPolicy, MaskableActorCriticGATPolicy)):
            raise ValueError("Policy must subclass MaskableActorCriticPolicy or MaskableActorCriticGATPolicy")
    ...
    def learn(
        ...
        while self.num_timesteps < total_timesteps:
            ...
            if log_interval is not None and iteration % log_interval == 0:
                ...
                if len(self.ep_info_buffer) > 0 and len(self.ep_info_buffer[0]) > 0:
                    ...
                    # Rollout mean is the last "l" key in the ep_info_buffer
                    # ep_len = self.ep_info_buffer[-1]["l"]
                    # print(f"Episode info buffer: {self.ep_info_buffer}")
        ...
        self.last_ep_rew_mean = safe_mean([ep_info["r"] for ep_info in self.ep_info_buffer])
