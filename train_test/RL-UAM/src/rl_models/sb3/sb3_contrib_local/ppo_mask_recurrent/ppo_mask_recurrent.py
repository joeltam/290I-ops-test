...
from src.rl_models.sb3.sb3_contrib_local.common.maskable_recurrent.buffers import MaskableRecurrentDictRolloutBuffer, MaskableRecurrentRolloutBuffer
from src.rl_models.sb3.sb3_contrib_local.common.maskable_recurrent.policies import MaskableRecurrentActorCriticPolicy, MaskableRecurrentActorCriticGATPolicy
from src.rl_models.sb3.sb3_contrib_local.common.maskable_recurrent.buffers import RNNStates
from sb3_contrib.common.maskable.utils import get_action_masks, is_masking_supported
from src.rl_models.sb3.sb3_contrib_local.ppo_mask_recurrent.policies import MlpLstmPolicy, GATLstmPolicy
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                mask = rollout_data.done_mask > 1e-8
            ...
            if log_interval is not None and iteration % log_interval == 0:
                ...
                if len(self.ep_info_buffer) > 0 and len(self.ep_info_buffer[0]) > 0:
                    ...
                    if ep_rew_mean is not None:
                        self.last_ep_rew_mean = ep_rew_mean
