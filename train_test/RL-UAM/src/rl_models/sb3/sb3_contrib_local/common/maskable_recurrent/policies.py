...
from src.rl_models.sb3.sb3_contrib_local.common.maskable_recurrent.distributions import MaskableDistribution, make_masked_proba_distribution
...
class MaskableRecurrentActorCriticPolicy(ActorCriticPolicy):
    ...
    def forward(
        ...
        :param action_masks: Masks out invalid actions (optional)
...
class MaskableRecurrentActorCriticGATPolicy(MaskableRecurrentActorCriticPolicy):
    def __init__(
        self,
        observation_space: spaces.Space,
        action_space: spaces.Space,
        ...
        use_expln: bool = False,
        squash_output: bool = False,
        features_extractor_class: Type[BaseFeaturesExtractor] = CustomGATFeatureExtractor,
        features_extractor_kwargs: Optional[Dict[str, Any]] = None,
        share_features_extractor: bool = True,
        normalize_images: bool = True,
        optimizer_class: Type[th.optim.Optimizer] = th.optim.Adam,
